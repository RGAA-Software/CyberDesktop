...
pub use editor_text_engine::{
    Cursor, Document, FileMatches, Match,
...
pub use gpui::{
    ...
    EntityInputHandler, FocusHandle, Focusable, IntoElement, KeyDownEvent, MouseButton,
    MouseDownEvent, MouseMoveEvent, MouseUpEvent, Pixels, Point, Render, ScrollWheelEvent,
    SharedString, Size, Stateful, TextRun, UTF16Selection, Window, DragMoveEvent,
};
