...
pub(crate) fn estimated_line_width(char_width: Pixels, line_len_chars: usize) -> Pixels {
    char_width * line_len_chars as f32
}

pub(crate) fn caret_x_from_col(char_width: Pixels, col: usize) -> Pixels {
