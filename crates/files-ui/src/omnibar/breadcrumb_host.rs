...
use files_fs::{BreadcrumbMenuSection, DirectoryReadOptions, PathBreadcrumb};
use gpui::{App, Window};
...
pub struct OmnibarBreadcrumbCallbacks {
    ...
    pub on_drop_external_paths: Rc<dyn Fn(PathBuf, Vec<PathBuf>, &mut Window, &mut App)>,
    pub on_drag_hover: Rc<dyn Fn(PathBuf, Vec<PathBuf>, &mut Window, &mut App)>,
    pub on_drag_hover_external: Rc<dyn Fn(PathBuf, Vec<PathBuf>, &mut Window, &mut App)>,
...
impl OmnibarBreadcrumbCallbacks {
    ...
    pub fn breadcrumb_bar(
        ...
        super::breadcrumb_bar::PathBreadcrumbBar::new(
            ...
            self.on_drop_external_paths.clone(),
            self.on_drag_hover.clone(),
            self.on_drag_hover_external.clone(),
