...
fn apply_zed_font_families(cx: &mut App) {
    let theme = Theme::global_mut(cx);
    theme.font_family = ZED_UI_FONT_FAMILY.into();
    theme.mono_font_family = ZED_MONO_FONT_FAMILY.into();
}
