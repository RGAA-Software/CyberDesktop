...
use gpui::{
    ...
    Styled, Window, WindowBounds, WindowOptions, div, prelude::FluentBuilder as _, px, size,
};
use gpui_component::{
    ActiveTheme, Icon, IconName, Root, StyledExt, ThemeMode,
    h_flex,
    label::Label,
    list::ListItem,
                                            ...
                                            v_flex()
                                                ...
                                                .child(
                                                    h_flex()
                                                        ...
                                                        .child(
                                                            Label::new(machine.display_name.clone())
                                                                .text_xs()
